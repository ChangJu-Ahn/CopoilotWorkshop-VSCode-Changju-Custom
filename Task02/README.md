...
- 그리고 GitHub Copilot을 통해 프로세스도 개선해 봅니다.
...
- 이전 실습은? [여기로 이동하세요](https://github.com/ChangJu-Ahn/CopoilotWorkshop-VSCode-Changju-Custom/blob/main/Task01/README.md) - Task 1: 간단한 함수 및 테스트 코드 제안 받기 (Code Completion)
